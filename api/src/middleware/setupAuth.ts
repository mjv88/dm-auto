 ...
 * Accepts any valid session (runner or admin), extracts the user's
 * email, looks up the corresponding row in the `users` table to
 * resolve userId and tenantId, and attaches the result to
